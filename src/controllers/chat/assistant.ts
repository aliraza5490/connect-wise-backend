...
export default async (req: IReq, res: IRes) => {
  ...
  value.data.chat.unshift([
    'system',
    `My name is ${req.user.firstName} ${req.user.lastName}. I am a ${req.user.pricePerMonth ? 'Mentor' : 'Mentee'} at ConnectWise. ConnectWise is a Mentorship Platform. This is my bio - \`${req.user.bio}\`. You will act as my virtual assistant of ConnectWise. I will ask you questions and you will provide me with the answers. Please, don't ask questions about my personal info. Let's start by Greeting!`,
  ]);
